...
import jeff.ronald.autotext.provider.AutoTextContract.TriggerEntry;

/**
 * Created by jeff on 9/5/15.
 */
public class AutoTextDBHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 2;

    static final String DATABASE_NAME = "autotext.db";

    public AutoTextDBHelper(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + TriggerEntry.TABLE_NAME);
